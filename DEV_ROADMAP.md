...
## 🎯 **PHASE 1: LAYOUT & HOME PAGE** (Day 1 - Sept 30)

### 1. Core Layout Components
- [ ] 1.1 Create Navbar component (`src/components/ui/Navbar.tsx`)
  - [ ] 1.1.1 Logo/Brand "ऋग्कथा"
  - [ ] 1.1.2 Navigation links (About, GitHub, Demo)
  - [ ] 1.1.3 Responsive mobile menu
  - [ ] 1.1.4 Sticky/fixed positioning
  
- [ ] 1.2 Create Footer component (`src/components/ui/Footer.tsx`)
  - [ ] 1.2.1 Attribution & sources
  - [ ] 1.2.2 Social links (GitHub, Demo video)
  - [ ] 1.2.3 Privacy note ("Zero data collection")
  - [ ] 1.2.4 Hackathon credit

- [ ] 1.3 Update App.tsx
  - [ ] 1.3.1 Import Navbar and Footer
  - [ ] 1.3.2 Wrap Routes with layout components
  - [ ] 1.3.3 Test routing structure

### 2. Homepage Development (`src/pages/Home.tsx`)
- [ ] 2.1 Hero Section
  - [ ] 2.1.1 Large "ऋग्कथा" heading
  - [ ] 2.1.2 Tagline: "Ancient Wisdom Through Comics"
  - [ ] 2.1.3 Background image/pattern
  - [ ] 2.1.4 Responsive typography
  
- [ ] 2.2 "Choose Your Path" Section
  - [ ] 2.2.1 Section heading
  - [ ] 2.2.2 Create PathCard component (`src/components/ui/PathCard.tsx`)
  - [ ] 2.2.3 Card 1: Browse by Deity (🎭)
  - [ ] 2.2.4 Card 2: Browse by Theme (🎯)
  - [ ] 2.2.5 Card 3: Browse by Mandala (📚)
  - [ ] 2.2.6 Grid layout (3 columns desktop, 1 column mobile)
  - [ ] 2.2.7 Hover effects and animations
  
- [ ] 2.3 Featured Story Section
  - [ ] 2.3.1 "Story of the Day" heading
  - [ ] 2.3.2 Story preview card
  - [ ] 2.3.3 Image placeholder
  - [ ] 2.3.4 Read Now button
  
- [ ] 2.4 Stats Bar
  - [ ] 2.4.1 Display: Hymns count, Mandalas, No login, Zero data
  - [ ] 2.4.2 Icon + text layout

### 3. Theme & Styling
- [ ] 3.1 Define color palette
  - [ ] 3.1.1 Primary: Saffron/Amber (#D97706, #F59E0B)
  - [ ] 3.1.2 Secondary: Deep Brown (#78350F, #451A03)
  - [ ] 3.1.3 Accent: Gold (#FCD34D)
  - [ ] 3.1.4 Background: Cream/Beige (#FEF3C7)
  - [ ] 3.1.5 Text: Dark brown (#292524)
  
- [ ] 3.2 Typography
  - [ ] 3.2.1 Devanagari font for Sanskrit
  - [ ] 3.2.2 Serif font for headings (elegant, scholarly)
  - [ ] 3.2.3 Sans-serif for body (readable)
  
- [ ] 3.3 Global styles
  - [ ] 3.3.1 Update index.css with theme variables
...
- **Sept 30**: Phase 1 - Steps 1, 2, 3 ☐
- **Oct 1**: Phase 2 - Steps 4, 5, 6 ☐
